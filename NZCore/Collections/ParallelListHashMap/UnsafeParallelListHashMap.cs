// <copyright project="NZCore" file="UnsafeParallelListHashMap.cs">
...
namespace NZCore
{
        ...
        where TValue : unmanaged
    {
        ...
        internal static UnsafeParallelListHashMap<TKey, TValue>* Create<TAllocator>(int initialCapacity, ref TAllocator allocator,
            NativeArrayOptions options = NativeArrayOptions.UninitializedMemory)
            where TAllocator : unmanaged, AllocatorManager.IAllocator
        {
            var unsafeArrayHashMap = CollectionInternals.Allocate(ref allocator, default(UnsafeParallelListHashMap<TKey, TValue>), 1);
        ...
        where TValue : unmanaged
    {
        ...
        private UnsafeParallelListHashMapIterator<TKey> _iterator;
    ...
    public unsafe struct MultipleArrayIndexer
    {
        ...
        public static MultipleArrayIndexer Null => new()
        {
            InternalIndex = -1,
            PtrToKey = null,
            PtrToValue = null
