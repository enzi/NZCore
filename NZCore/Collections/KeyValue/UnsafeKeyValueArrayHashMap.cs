// <copyright project="NZCore" file="UnsafeKeyValueArrayHashMap.cs">
...
namespace NZCore
{
        ...
        where TValue : unmanaged
    {
        ...
        {
            var unsafeArrayHashMap = CollectionInternals.Allocate(ref allocator, default(UnsafeKeyValueArrayHashMap<TKey, TValue>), 1);
