...
namespace NZCore
{
        ...
        where T : unmanaged
    {
        ...
        public int GetChunkCount() => _unsafeParallelList->GetChunkCount();
        ...
        public byte* GetPerThreadListPtr() => _unsafeParallelList->GetPerThreadListPtr();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref UnsafeList<T> GetUnsafeList(int threadIndex) => ref _unsafeParallelList->GetUnsafeList(threadIndex);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UnsafeList<T>* GetUnsafeListPtr(int threadIndex) => _unsafeParallelList->GetUnsafeListPtr(threadIndex);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int GetBlockCount(int threadIndex) => _unsafeParallelList->BlockCount(threadIndex);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int GetBlockCountToIndex(int threadIndex) => _unsafeParallelList->BlockCountToIndex(threadIndex);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeArray<int> GetStartIndexArray(ref SystemState state) => _unsafeParallelList->GetStartIndexArray(ref state);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int GetStartIndexArray(ref NativeArray<int> lengths) => _unsafeParallelList->GetStartIndexArray(ref lengths);
        ...
        public ParallelListEnumerator GetEnumerator() => new(this);

        public void Report()
        {
            for (var i = 0; i < JobsUtility.ThreadIndexCount; i++)
            {
                ref var parallelList = ref _unsafeParallelList->GetUnsafeList(i);
        ...
        {
            private UnsafeParallelList<T>.ChunkWriter _chunkWriter;
            ...
            {
                _chunkWriter = parallelList._unsafeParallelList->AsChunkWriter();
            ...
            {
                _chunkWriter.BeginForEachChunk(chunkIndex);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void Write(in T value)
            {
                _chunkWriter.Write(in value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void WriteMemCpy(ref T value)
            {
                _chunkWriter.WriteMemCpy(ref value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void EndForEachChunk()
            {
                _chunkWriter.EndForEachChunk();
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetManualThreadIndex(int threadIndex)
            {
                _chunkWriter.SetManualThreadIndex(threadIndex);
            }

            public int GetThreadIndex() => _chunkWriter.GetThreadIndex();
        }
        ...
        {
            private UnsafeParallelList<T>.ChunkReader _chunkReader;
            ...
            {
                _chunkReader = stream._unsafeParallelList->AsChunkReader();
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public int BeginForEachChunk(int chunkIndex) => _chunkReader.BeginForEachChunk(chunkIndex);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ref T Read() => ref _chunkReader.Read();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public T* GetPtr() => _chunkReader.GetPtr();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void Reset(int chunkIndex)
            {
                _chunkReader.Reset(chunkIndex);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public int GetListIndex(int chunkIndex) => _chunkReader.GetListIndex(chunkIndex);
        }
        ...
        {
            private UnsafeParallelList<T>.ThreadWriter _threadWriter;
            ...
            {
                _threadWriter = parallelList._unsafeParallelList->AsThreadWriter();
            ...
            {
                _threadWriter.Begin(threadIndex);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void Write(in T value)
            {
                _threadWriter.Write(in value);
            }
            ...
            public void WriteMemCpy(ref T value)
            {
                _threadWriter.WriteMemCpy(ref value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ref UnsafeList<T> GetList() => ref _threadWriter.GetList();

            public int GetThreadIndex() => _threadWriter.GetThreadIndex();
        }
        ...
        {
            private UnsafeParallelList<T>.ThreadReader _threadReader;
            ...
            {
                _threadReader = stream._unsafeParallelList->AsThreadReader();
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public int Begin() => _threadReader.Begin();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public int Begin(int threadIndex) => _threadReader.Begin(threadIndex);

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ref T Read() => ref _threadReader.Read();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public T* GetPtr() => _threadReader.GetPtr();
        }
        ...
        public JobHandle CopyToArraySingleAndIndex<TKey>(
            ...
            new ParallelListToArrayAndIndexSingleThreaded<TKey>
            {
                ParallelList = this,
                List = nativeList,
        ...
        public JobHandle CopyToArraySingleAndIndex<TKey>(
            ...
            where TKey : unmanaged, IEquatable<TKey> =>
            new ParallelListToArrayAndIndexSingleThreadedForTwoMaps<TKey>
            {
                ParallelList = this,
                List = nativeList,
        ...
        public struct ParallelListToArraySingleThreaded : IJob
        {
            ...
            public void Execute()
            {
                ...
                var dst = (byte*)(List.GetUnsafePtr() + oldListLength);

                for (var i = 0; i < JobsUtility.ThreadIndexCount; i++)
                {
                    ref var threadList = ref ParallelList.GetUnsafeList(i);
                    var threadByteLength = threadList.m_length * sizeof(T);
        ...
        public struct UnsafeParallelListToArraySingleThreaded : IJob
        {
            ...
            public void Execute()
            {
                ...
                var dst = (byte*)(List->Ptr + oldListLength);
            ...
            where TKey : unmanaged, IEquatable<TKey>
        {
            ...
            public void Execute()
            {
                var parallelListLength = ParallelList.Length;
                var oldListLength = List.Length;
                var newLength = oldListLength + parallelListLength;
                ...
                var dst = listPtr + oldListLength * sizeOf;
        ...
        public JobHandle CopyToArrayParallelAndIndex<TKey>(ref NativeList<T> nativeList, ref ArrayHashMap<TKey, T> arrayHashMap,
            ref ArrayHashMap<TKey, T> arrayHashMap2, JobHandle dependency)
            where TKey : unmanaged, IEquatable<TKey>
        {
        ...
        public struct ParallelListToArrayMultiThreaded : IJobFor
        {
            ...
            public void Execute(int index)
            {
                ...
                var threadListLength = threadList.Length;
            ...
            where TKey : unmanaged, IEquatable<TKey>
        {
            ...
            [NativeDisableContainerSafetyRestriction]
            private NativeList<T> _tmpList1;
        ...
        {
            private ParallelList<T> _parallelList;
            ...
            public bool MoveNext()
            {
                ...
                {
                    _listPtr = _parallelList.GetUnsafeListPtr(_currentIndex);
                    _currentIndex++;

                    if (_listPtr->Length > 0)
                    {
                        return true;
                    }
                }
