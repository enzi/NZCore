// <copyright project="NZCore" file="UnsafeKeyDynamicValueArrayHashMap.cs">
...
namespace NZCore
{
        ...
        where TKeyInterpreter : unmanaged, IKeyInterpreter<TKey>
    {
        ...
        {
            var unsafeArrayHashMap = CollectionInternals.Allocate(ref allocator, default(UnsafeKeyDynamicValueArrayHashMap<TKey, TKeyInterpreter>), 1);
        ...
        public void Dispose()
        {
            CollectionInternals.DestroyList(next, ref m_Allocator);
            CollectionInternals.DestroyList(buckets, ref m_Allocator);
        }
    }
