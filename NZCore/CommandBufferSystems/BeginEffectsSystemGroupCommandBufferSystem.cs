...
namespace NZCore
{
    ...
    [UpdateInGroup(typeof(NZEffectsInitializationSystemGroup), OrderFirst = true)]
    public partial class BeginEffectsSystemGroupCommandBufferSystem : EntityCommandBufferSystem
    {
