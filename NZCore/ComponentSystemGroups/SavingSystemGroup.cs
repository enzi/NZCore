...
{
#if UNITY_NETCODE
    [WorldSystemFilter(WorldSystemFilterFlags.ServerSimulation | WorldSystemFilterFlags.Editor, WorldSystemFilterFlags.ServerSimulation | WorldSystemFilterFlags.Editor)]
