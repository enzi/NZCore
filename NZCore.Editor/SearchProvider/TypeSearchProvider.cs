// <copyright project="NZCore.Editor" file="TypeSearchProvider.cs">
...
namespace NZCore.Editor
{
    public class TypeSearchProvider : BaseSearchProvider
    {
        ...
        {
            yield return new SearchProposition(null, "Name", "name:", "Filter by type name.", 0, TextCursorPlacement.MoveAutoComplete, null, null, null,
                new Color());
        ...
        private static object GetNamespace(SearchColumnEventArgs args) => args.item.data is not Type t ? null : t.Namespace;

        private static object GetAssemblyName(SearchColumnEventArgs args) => args.item.data is not Type t ? null : t.Assembly.GetName().Name;
