// <copyright project="NZCore.MVVM" file="GenericRootViewModel.cs">
...
{
    /// <summary>
    /// Generic RootViewModel that provides strongly-typed access to a specific model type.
    /// </summary>
    /// <typeparam name="T">The type of model this RootViewModel manages.</typeparam>
    public abstract class RootViewModel<T> : RootViewModel
        where T : Model
    {
        /// <summary>
        /// Gets or sets the strongly-typed model associated with this RootViewModel.
        /// </summary>
        public new T Model
        {
            get => base.Model as T;
