// <copyright project="NZCore.MVVM" file="RelayCommand.cs">
...
namespace NZCore.MVVM
{
    ...
    /// <summary>
    /// A generic command that relays its functionality by invoking delegates with strongly-typed parameters.
    /// </summary>
